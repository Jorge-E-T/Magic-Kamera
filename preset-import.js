...
const STARTER_PRESETS = ['BATTLESHIP', 'CARICATURE', 'CLAYMATION', 'CLUE', 'GUESS WHO', 'HIDE AND SEEK', 'IMPRESSIONISM', 'LEGO', 'ROCK PAPER SCISSORS LIZARD SPOCK', 'SLOT MACHINE', 'WORDLE'];
